...
function Home() {
  ...
  return (
    <container>
    <h1 className="flex justify-center text-blue-400 text-5xl py-6">Home</h1> 

     <div className="relative flex w-full mx-auto max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
