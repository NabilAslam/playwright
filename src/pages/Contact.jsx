...
<div class="relative isolate bg-gray-900 h-screen overflow-scroll bg-cover bg-no-repeat flex flex-col items-center">
<h1 className="text-blue-400 text-5xl pt-20">Contact</h1> 
      ...
      <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
        <div class="absolute inset-y-0 left-0 -z-10 w-full overflow-hidden ring-1 ring-white/5 lg:w-1/2">
          ...
          <div class="absolute -left-56 top-[calc(100%-13rem)] transform-gpu blur-3xl lg:left-[max(-14rem,calc(100%-59rem))] lg:top-[calc(50%-7rem)]" aria-hidden="true">
            <div class="aspect-[1155/678] w-[72.1875rem] bg-gradient-to-br from-[#80caff] to-[#4f46e5] opacity-20" style={{clipPath: "polygon(74.1% 56.1%, 100% 38.6%, 97.5% 73.3%, 85.5% 100%, 80.7% 98.2%, 72.5% 67.7%, 60.2% 37.8%, 52.4% 32.2%, 47.5% 41.9%, 45.2% 65.8%, 27.5% 23.5%, 0.1% 35.4%, 17.9% 0.1%, 27.6% 23.5%, 76.1% 2.6%, 74.1% 56.1%)"}}></div>
          </div>
        </div>
        <h2 class="text-3xl font-bold tracking-tight text-white">Feel free to contact us</h2>
        <p class="mt-6 text-lg leading-8 text-gray-300">The Schwarzer Company is here to assist you throughout the way</p>
        <dl class="mt-10 space-y-4 text-base leading-7 text-gray-300">
          ...
          <div class="flex gap-x-4">
            ...
            <dd><a class="hover:text-white" href="tel:+1 (555) 234-5678">+2 0323 390-0182</a></dd>
          </div>
          <div class="flex gap-x-4">
            <dt class="flex-none">
            ...
            <dd><a class="hover:text-white" href="mailto:hello@example.com">schwarzer@gmail.com</a></dd>
          </div>
        </dl>
      </div>
    </div>
